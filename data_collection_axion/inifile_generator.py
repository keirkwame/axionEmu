...
for i in range(number_cores):
    new_folder = '/home/keir/keir/LH_ACT_DR6_TTTEEEPP_nu2_'+str(i)
    os.system('mkdir ' + new_folder)
    new_name = '/home/keir/keir/LH_ACT_DR6_TTTEEEPP_nu2_inifile_'+str(i)
    f1=open('default_inifile_00', 'r')
    lines = f1.readlines()
    f1.close()
    lines[3] = 'output_root = '+ new_folder +'/LH_ACT_DR6_TTTEEEPP_nu2_'+str(i)+'\n'
