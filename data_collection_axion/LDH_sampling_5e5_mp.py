...
n_params = 12
n_samples = 180000 #180000 #150000
...
data_pkl = 'LHD_parameters_180k_HMcode.pkl' #the .pkl that stores all input parameters
f = open(data_pkl, 'wb')
...
for i in range(num_subfile):
    ...
    data_pkl = 'LHD_parameters_180k_HMcode' +str(i) +'.pkl'
    f = open(data_pkl, 'wb')
