    ...
    if log_prior_value == -np.inf:
        ...
        if log_likelihood_value == -np.inf:
            ...
            if log_likelihood_value_Planck == -np.inf:
                ...
                return log_prior_value + log_likelihood_value + log_likelihood_value_Planck
...
FIDUCIAL = np.reshape(np.array([0.022242,  0.1,  0.673,  0.065,  0.9658,  3.0753, -26.1, 0.006, 1.0]).astype('float32'), (1, 9))
...
with Pool(processes=60) as pool:
    ...
    filename = "Lyaf_eBOSS_Planck_500_wider_prior.h5"
    ...
    diff = end - start
    data_pkl = 'Lyaf_eBOSS_Planck_axionCAMB_500_wider_prior'+'.pkl'
    ...
    plt.savefig('convergence_test_Lyaf_eBOSS_Planck_500_wider_prior.png')
